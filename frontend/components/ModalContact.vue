<template>
    <div id="mdl-contacts" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="social-directions">
              ...
              <div class="input-group" :class="[address !== '' ? 'active' : '']">
                <input v-model="address" type="text" class="form-control form-control-lg" 
                  :placeholder="$t('modalcontact.show_direction')" aria-describedby="button-addon4">
                <div id="button-addon4" class="input-group-append">
                  <button class="btn" type="button" :class="[type === 0 ? 'active' : '']" @click="type=0"><img class="svgIcons" src="/img/car.svg"/></button>
                  <button class="btn" type="button" :class="[type === 1 ? 'active' : '']" @click="type=1"><img class="svgIcons" src="/img/bus.svg"/></button>
                </div>
              </div>
            </div>
          </div>
