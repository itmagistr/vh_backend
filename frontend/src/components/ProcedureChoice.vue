            ...
            <div class="table-wrapper-scroll-y my-custom-scrollbar">
                  ...
                  <table class="table table-borderless">
                        <tbody v-for="n in cat" :key="n.tittle">
                              ...
                              <tr v-for="c in n.results" class="product" :class="[{spec: c.date.length > 5}, { active: c.uuid === select}]" :key="c.uuid" @click="selected(c.uuid)">
                                    <td class="pr-date">{{ c.date }}</td>
        ...
        return {
            ...
            cat: [
                {uuid: '18abdf34-516f-4e95-9b61-2d2052d4f60d', img: '/img/Teeth/Orthodontics.svg', tittle: '01. Ортодонтия', results: [
                    {uuid: '57e5b77b-8722-411c-ae2a-ac0c484186cb', date: '01.01', tittle: 'Установка брекетов', price: 150000, duration: 90},
                    {uuid: '951a9eb9-e0a4-444c-a060-a1d6a1e65181', date: '01.02', tittle: 'Замена брекет-системы', price: 3000, duration: 30},
                    {uuid: '86862dce-dcee-4fed-9f84-5568cd2ce088', date: '01.03', tittle: 'Очень длинное название процедуры, очень длинное', price: 10000, duration: 120},
                    {uuid: '222acbed-7f8b-45c4-b113-2b0df57f2b74', date: '01.03.01', tittle: 'Очень длинное название процедуры, очень длинное врач Василенко Л.И.', price: 10000, duration: 90},
                    {uuid: '9e165e33-0205-4f10-b57a-94cc7009037a', date: '01.03.02', tittle: 'Очень длинное название процедуры, очень длинное врач Василенко Л.И.', price: 15000, duration: 90},
                    {uuid: '181c9634-de66-44fa-a4fe-d7a59f8842ce', date: '01.04', tittle: 'Изготовление Капп', price: 500, duration: 15},]
                },
                {uuid: '72c10fc6-350a-42ef-888a-4835f88de9ca', img: '/img/Teeth/Implantation.svg', tittle: '02. Хирургия', results: [
                    {uuid: 'c210c3c5-f406-43ea-ae0a-85c99fc8b30e', date: '01.01', tittle: 'Установка брекетов', price: 150000, duration: 90},
                    {uuid: '3a7e973e-1df8-4ec3-8954-2df798f6bac6', date: '01.02', tittle: 'Замена брекет-системы', price: 3000, duration: 30},
                    {uuid: '341c9610-addd-45f2-8bc1-f4529956cc7a', date: '01.03', tittle: 'Очень длинное название процедуры, очень длинное', price: 10000, duration: 120},
                    {uuid: '697940ed-05d2-4f77-b5b1-d50b0c8dcc4c', date: '01.03.01', tittle: 'Очень длинное название процедуры, очень длинное врач Василенко Л.И.', price: 10000, duration: 90},
                    {uuid: '7e182f76-b16e-4885-b913-6bcd07ba3c68', date: '01.03.02', tittle: 'Очень длинное название процедуры, очень длинное врач Василенко Л.И.', price: 15000, duration: 90},
                    {uuid: 'd8853c50-282f-4a14-9866-c72cc2b32dd7', date: '01.04', tittle: 'Изготовление Капп', price: 500, duration: 15},]
                },
            ],
        }
    },
